  ...
  return (
    <>
      <section className="overflow-hidden bg-white">
        <div className="relative overflow-hidden cursor-pointer" style={{ height: "460px" }}>
          <div
          ...
          <button
            ...
            className="cursor-pointer absolute left-4 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full bg-white/20 backdrop-blur text-white flex items-center justify-center hover:scale-110 transition"
          >
            <ChevronLeft size={24} />
          </button>
          ...
          <button
            ...
            className="cursor-pointer absolute right-4 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full bg-white/20 backdrop-blur text-white flex items-center justify-center hover:scale-110 transition"
          >
